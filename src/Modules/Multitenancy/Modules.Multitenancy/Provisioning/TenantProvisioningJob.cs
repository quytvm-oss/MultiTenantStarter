...
{
    private readonly ITenantProvisioningStateWriter _provisioningService;
    ...
    public TenantProvisioningJob(ITenantProvisioningStateWriter provisioningService, 
    ...
    public async Task RunAsync(string tenantId, string correlationId, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            if (runDatabase)
            {
                await _provisioningService
                    .MarkStepCompletedAsync(tenantId, correlationId, currentStep, cancellationToken)

...
using ActivityKind = Modules.Auditing.Contracts.ActivityKind;
...
public static class Audit
{
    ...
    public static Builder ForEntityChange(
        ...
        => new Builder(
            type: AuditEventType.EntityChange,
            severity: AuditSeverity.Information,
            payload: new EntityChangeEventPayload(dbContext, schema, table, entityName, key, operation,
                changes.ToArray(), TransactionId: null));
    ...
    private static List<string> StackTop(Exception ex, int maxFrames)
    {
        ...
        foreach (var f in trace.GetFrames() ?? Enumerable.Empty<StackFrame>())
        {
    ...
    private static Dictionary<string, object?>? ToDict(IDictionary? data)
    {
    ...
    public sealed class Builder
    {
        ...
        internal Builder(AuditEventType type, AuditSeverity severity, object payload)
        {
            _type = type;
            _severity = severity;
            _payload = payload;
        ...
        public Builder WithSeverity(AuditSeverity severity)
        {
            _severity = severity;
            return this;
        }
        ...
        public Builder WithUser(string? userId, string? userName = null)
        {
            _userId = userId;
            _userName = userName;
            return this;
        ...
        public Builder WithTrace(string? traceId, string? spanId = null)
        {
            _traceId = traceId;
            _spanId = spanId;
            return this;
        ...
        public Builder WithCorrelation(string? correlationId)
        {
        ...
        public Builder WithTags(AuditTag tags)
        {
            _tags |= tags;   
            return this;
        }
        public Builder At(DateTime occurredAtUtc)
        {
            _occurredAtUtc = occurredAtUtc.Kind == DateTimeKind.Utc ? occurredAtUtc : occurredAtUtc.ToUniversalTime();
            return this;
        }

        public Builder WithEntityTransactionId(string? transactionId)
        {
            if (_payload is EntityChangeEventPayload s) 
                _payload = s with{ TransactionId = transactionId };
            return this;
        }
    ...
    {
        public IAuditScope CurrentScope { get; } = new DefaultAuditScope(null, null, null, null,
            null, null, null, null, AuditTag.None);

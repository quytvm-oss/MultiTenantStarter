...
{
    private readonly ILogger<PostgreSqlStorageInitializer> _logger;
    ...
    public string GetPublishedTableName()
        => $"{_options.Value.Schema}.{_options.Value.PublishName}";

    public string GetReceivedTableName()
        => $"{_options.Value.Schema}.{_options.Value.ReceivedName}";

    public string GetLockTableName()
        => $"{_options.Value.Schema}.{_options.Value.LockName}";
    ...
    public async Task InitializeAsync(CancellationToken cancellationToken)
    {
        ...
        [
            new NpgsqlParameter("@PubKey", $"publish_retry"),
            new NpgsqlParameter("@RecKey", $"received_retry"),

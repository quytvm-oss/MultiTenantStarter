...
public static class ModuleLoader
{
    ...
    public static IHostApplicationBuilder AddModules(this IHostApplicationBuilder builder, bool IsWebHost = true, params Assembly[] assemblies)
    {
        ...
        lock (_lock)
        {
            ...
            foreach (var moduleType in moduleRegistrations)
            {
                ...
                module.ConfigureServices(builder, IsWebHost);

...
internal static partial class PostgresMigratorLock
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        while (DateTime.UtcNow <  deadline)
        {
            ...
            catch (PostgresException e) when (e.SqlState == "3D000")
            {
                ...
                LogTargetDatabaseMissing(logger, e);
                return;
            }
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            LogSkipLockForMissingDb(logger,e);
    ...
    private sealed class LockHolder : IAsyncDisposable
    {
        ...
        public async ValueTask DisposeAsync()
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add(new NpgsqlParameter("key", NpgsqlDbType.Bigint)
                { 
                    Value = MigratorAdvisoryLockKey
                });

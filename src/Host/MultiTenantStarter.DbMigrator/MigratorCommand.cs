    ...
    bool Help)
{
    ...
    public const string HelpText = """
           MultiTenantStater DbMigrator — apply EF Core migrations across the tenant catalog
           and every tenant's per-module databases.

           Usage:
             dotnet run --project src/Host/MultiTenantStater.Starter.DbMigrator -- [verb] [options]

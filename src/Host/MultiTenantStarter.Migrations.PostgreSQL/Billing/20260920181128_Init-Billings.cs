...
namespace MultiTenantStarter.Migrations.PostgreSQL.Billing
{
    /// <inheritdoc />
    public partial class InitBillings : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Purpose = table.Column<string>(type: "text", nullable: false, defaultValue: "Usage"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Currency = table.Column<string>(type: "character varying(8)", maxLength: 8, nullable: false),
                    Interval = table.Column<string>(type: "text", nullable: false, defaultValue: "Monthly"),

...
namespace MultiTenantStarter.Migrations.PostgreSQL.Billing
{
    ...
    [Migration("20260920181128_Init-Billings")]
    partial class InitBillings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Modules.Billing.Domain.BillingPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Modules.Billing.Domain.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "PeriodYear", "PeriodMonth", "Purpose")
                        ...
                        .HasFilter("\"Purpose\" <> 'Topup'");

                    b.ToTable("Invoices", "billing");
                });

            modelBuilder.Entity("Modules.Billing.Domain.InvoiceLineItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Modules.Billing.Domain.Subscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Modules.Billing.Domain.TopupRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Modules.Billing.Domain.UsageSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Modules.Billing.Domain.Wallet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Modules.Billing.Domain.WalletTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Modules.Billing.Domain.BillingPlan", b =>
                {
                    b.OwnsOne("Core.Domain.ValueObjects.Money", "AnnualPrice", b1 =>
                        {
                    ...
                    b.OwnsOne("Core.Domain.ValueObjects.Money", "MonthlyBasePrice", b1 =>
                        {
                            b1.Property<Guid>("BillingPlanId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Modules.Billing.Domain.Invoice", b =>
                {
                    b.OwnsOne("Core.Domain.ValueObjects.Money", "SubtotalAmount", b1 =>
                        {
            ...
            modelBuilder.Entity("Modules.Billing.Domain.InvoiceLineItem", b =>
                {
                    b.HasOne("Modules.Billing.Domain.Invoice", null)
                        .WithMany("LineItems")
                        .HasForeignKey("InvoiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("Core.Domain.ValueObjects.Money", "Amount", b1 =>
                        {
            ...
            modelBuilder.Entity("Modules.Billing.Domain.Wallet", b =>
                {
                    b.OwnsOne("Core.Domain.ValueObjects.Money", "Balance", b1 =>
                        {
            ...
            modelBuilder.Entity("Modules.Billing.Domain.WalletTransaction", b =>
                {
                    b.HasOne("Modules.Billing.Domain.Wallet", null)

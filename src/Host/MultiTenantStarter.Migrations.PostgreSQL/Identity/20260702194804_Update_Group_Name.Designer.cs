...
namespace MultiTenantStarter.Migrations.PostgreSQL.Identity
{
    ...
    [Migration("20260702194804_Update_Group_Name")]
    partial class Update_Group_Name
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Modules.Identity.Domain.Group", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Modules.Identity.Domain.GroupRole", b =>
                {
            ...
            modelBuilder.Entity("Modules.Identity.Domain.ImpersonationGrant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Jit", "TenantId")
                        .IsUnique()
                        .HasDatabaseName("IX_ImpersonationGrants_Jit");
            ...
            modelBuilder.Entity("Modules.Identity.Domain.PasswordHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Modules.Identity.Domain.RoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Modules.Identity.Domain.UserGroup", b =>
                {
                    b.Property<string>("UserId")
                        .HasMaxLength(450)
                        .HasColumnType("character varying(450)");
            ...
            modelBuilder.Entity("Modules.Identity.Domain.UserSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Modules.Identity.Domain.GroupRole", b =>
                {
                    b.HasOne("Modules.Identity.Domain.Group", "Group")
                        .WithMany("GroupRoles")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Modules.Identity.Domain.Role", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Modules.Identity.Domain.UserGroup", b =>
                {
                    ...
                    b.HasOne("Modules.Identity.Domain.Group", null)
                        .WithMany("UserGroups")
